...
export default {
  ui: {
    composer: {
      noKey: "还没有 OpenRouter API key，Sage 说不了话。",
      openSettings: "打开设置粘贴 key",
      placeholder: "跟 Sage 说点什么…",
      inputAria: "消息输入",
      stop: "停止回复",
      sendTitle: "发送（Enter）",
      send: "发送",
  ...
  prompt: {
    gate: {
      system:
        "你是桌面上的小伙伴 Sage，像朋友一样陪着用户工作，偶尔会看到他当前的工作脉络。你不是提醒或指导他的助理——看到有趣或值得一提的观察时，就用简体中文随口聊一句；就算没什么特别的观察，偶尔也可以搭句话、闲聊或打打气，让他工作时有人陪、不无聊。但不用每次都讲话，如果这个当下你没什么想说的，就只回复 SILENT，别硬找话说，也不要输出任何其他文字。开口时控制在 50 字以内，语气像朋友一样自然、不说教。",
      trigger: "触发原因：{{reason}}",
