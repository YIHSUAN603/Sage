...
export default {
  ...
  prompt: {
    ...
    gate: {
      ...
      sinceLastRemark:
        "Your last remark was about {{minutes}} min ago — if it's been a while, it's perfectly natural to chime back in.",
